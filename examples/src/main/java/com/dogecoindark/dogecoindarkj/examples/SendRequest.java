...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Have a look at the code of the SendRequest class to see what's happening and what other options you have: https://dogecoindarkj.github.io/javadoc/0.11/com/google/bitcoin/core/Wallet.SendRequest.html
        // 
