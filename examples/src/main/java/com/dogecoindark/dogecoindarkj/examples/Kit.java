...
import com.dogecoindark.dogecoindarkj.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by dogecoindarkj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV dogecoindarkj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // 
        // For more information have a look at: https://dogecoindarkj.github.io/testing and https://bitcoin.org/en/developer-examples#testing-applications
        ...
        // Have a look at the WalletAppKit documentation and its source to understand what's happening behind the scenes: https://github.com/dogecoindarkj/dogecoindarkj/blob/master/core/src/main/java/org/dogecoindarkj/kits/WalletAppKit.java
        ...
        // dogecoindarkj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://code.google.com/p/guava-libraries/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();

        // To observe wallet events (like coins received) we implement a EventListener class that extends the AbstractWalletEventListener dogecoindarkj then calls the different functions from the EventListener class
