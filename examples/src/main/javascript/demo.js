...
// To run, grab the dogecoindarkj bundled JAR and then do something like this:
//
//   jjs -cp dogecoindarkj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp dogecoindarkj-0.12-bundled.jar
//
...
//
//   jjs -cp dogecoindarkj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And dogecoindarkj is a threaded library. This means you
