...
package com.dogecoindark.dogecoindarkj.tools;

import com.dogecoindark.dogecoindarkj.core.*;
import com.dogecoindark.dogecoindarkj.core.Wallet.BalanceType;
import com.dogecoindark.dogecoindarkj.crypto.DeterministicKey;
import com.dogecoindark.dogecoindarkj.crypto.KeyCrypterException;
import com.dogecoindark.dogecoindarkj.crypto.MnemonicCode;
import com.dogecoindark.dogecoindarkj.crypto.MnemonicException;
import com.dogecoindark.dogecoindarkj.net.discovery.DnsDiscovery;
import com.dogecoindark.dogecoindarkj.params.MainNetParams;
import com.dogecoindark.dogecoindarkj.params.RegTestParams;
import com.dogecoindark.dogecoindarkj.params.TestNet3Params;
import com.dogecoindark.dogecoindarkj.protocols.payments.PaymentProtocol;
import com.dogecoindark.dogecoindarkj.protocols.payments.PaymentProtocolException;
import com.dogecoindark.dogecoindarkj.protocols.payments.PaymentSession;
import com.dogecoindark.dogecoindarkj.store.*;
import com.dogecoindark.dogecoindarkj.uri.BitcoinURI;
import com.dogecoindark.dogecoindarkj.uri.BitcoinURIParseException;
import com.dogecoindark.dogecoindarkj.utils.BriefLogFormatter;
import com.dogecoindark.dogecoindarkj.wallet.DeterministicSeed;
import com.dogecoindark.dogecoindarkj.wallet.DeterministicUpgradeRequiredException;
import com.dogecoindark.dogecoindarkj.wallet.DeterministicUpgradeRequiresPassword;
...
import com.dogecoindark.dogecoindarkj.wallet.MarriedKeyChain;
...
import static com.dogecoindark.dogecoindarkj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("dogecoindark")) {
            try {
                ...
                System.err.println("Invalid dogecoindark uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
