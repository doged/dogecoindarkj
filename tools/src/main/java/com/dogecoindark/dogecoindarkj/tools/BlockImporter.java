...
/** Very thin wrapper around {@link com.dogecoindark.dogecoindarkj.utils.BlockFileLoader} */
public class BlockImporter {
    public static void main(String[] args) throws BlockStoreException, VerificationException, PrunedException {
        ...
        System.out.println("       eg BlockImporter prod H2 /home/user/dogecoindarkj.h2store");
