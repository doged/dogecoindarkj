...
package com.dogecoindark.dogecoindarkj.wallet;

import com.dogecoindark.dogecoindarkj.core.BloomFilter;
 ...
 * {@link com.dogecoindark.dogecoindarkj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.dogecoindark.dogecoindarkj.crypto.MnemonicCode},
 ...
 * {@link com.dogecoindark.dogecoindarkj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.dogecoindark.dogecoindarkj.crypto.DeterministicKey#deserializeB58(com.dogecoindark.dogecoindarkj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.dogecoindark.dogecoindarkj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.dogecoindark.dogecoindarkj.crypto.DeterministicHierarchy} and
 * {@link com.dogecoindark.dogecoindarkj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.dogecoindark.dogecoindarkj.crypto.DeterministicKey)}
     ...
     * @see com.dogecoindark.dogecoindarkj.wallet.MarriedKeyChain
     */
