...
public interface BlockChainListener {
     ...
     * us via either {@link #receiveFromBlock(Transaction, StoredBlock, com.dogecoindark.dogecoindarkj.core.BlockChain.NewBlockType, int)}
     * or {@link #notifyTransactionIsInBlock(Sha256Hash, StoredBlock, com.dogecoindark.dogecoindarkj.core.BlockChain.NewBlockType, int)}.
