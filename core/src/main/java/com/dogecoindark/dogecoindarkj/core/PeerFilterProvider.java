 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(com.dogecoindark.dogecoindarkj.core.PeerGroup.FilterRecalculateMode)}
