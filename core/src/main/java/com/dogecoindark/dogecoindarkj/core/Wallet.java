...
import com.dogecoindark.dogecoindarkj.crypto.*;
import com.dogecoindark.dogecoindarkj.params.UnitTestParams;
import com.dogecoindark.dogecoindarkj.script.Script;
import com.dogecoindark.dogecoindarkj.script.ScriptBuilder;
import com.dogecoindark.dogecoindarkj.script.ScriptChunk;
import com.dogecoindark.dogecoindarkj.signers.MissingSigResolutionSigner;
...
import com.dogecoindark.dogecoindarkj.store.UnreadableWalletException;
import com.dogecoindark.dogecoindarkj.store.WalletProtobufSerializer;
import com.dogecoindark.dogecoindarkj.utils.BaseTaggableObject;
import com.dogecoindark.dogecoindarkj.utils.ExchangeRate;
import com.dogecoindark.dogecoindarkj.utils.ListenerRegistration;
import com.dogecoindark.dogecoindarkj.utils.Threading;
import com.dogecoindark.dogecoindarkj.wallet.*;
import com.dogecoindark.dogecoindarkj.wallet.WalletTransaction.Pool;
...
import com.dogecoindark.dogecoindarkj.store.FullPrunedBlockStore;
import com.dogecoindark.dogecoindarkj.wallet.Protos.Wallet.EncryptionType;
import com.dogecoindark.dogecoindarkj.wallet.AllRandomKeysRotating;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.dogecoindark.dogecoindarkj.wallet.WalletFiles.Listener)}
...
/*      This causes the wallet to try and mine a block. Remove it for now
     ...
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.dogecoindark.dogecoindarkj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.dogecoindark.dogecoindarkj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.dogecoindark.dogecoindarkj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.dogecoindark.dogecoindarkj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.dogecoindark.dogecoindarkj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.dogecoindark.dogecoindarkj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.dogecoindark.dogecoindarkj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.dogecoindark.dogecoindarkj.crypto.KeyCrypter,
     ...
     * {@link com.dogecoindark.dogecoindarkj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.dogecoindark.dogecoindarkj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.dogecoindark.dogecoindarkj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.dogecoindark.dogecoindarkj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.dogecoindark.dogecoindarkj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.dogecoindark.dogecoindarkj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
 ...
 //                       }
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.dogecoindark.dogecoindarkj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.dogecoindark.dogecoindarkj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
