...
import static com.dogecoindark.dogecoindarkj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.dogecoindark.dogecoindarkj.script.Script, ECKey, com.dogecoindark.dogecoindarkj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.dogecoindark.dogecoindarkj.core.Transaction.SigHash, boolean)}
