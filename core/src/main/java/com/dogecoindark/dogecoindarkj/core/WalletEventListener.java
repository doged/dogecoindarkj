...
import com.dogecoindark.dogecoindarkj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.dogecoindark.dogecoindarkj.core.Transaction#getConfidence()}. It's safe to modify the
