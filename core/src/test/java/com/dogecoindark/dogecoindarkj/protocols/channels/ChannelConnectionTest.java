...
import com.dogecoindark.dogecoindarkj.wallet.WalletFiles;
...
import static com.dogecoindark.dogecoindarkj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        com.dogecoindark.dogecoindarkj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
