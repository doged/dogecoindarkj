...
import com.dogecoindark.dogecoindarkj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    private static final String DB_NAME = "dogecoindarkj_test";
    private static final String DB_USERNAME = "dogecoindarkj";
