...
import com.dogecoindark.dogecoindarkj.net.NioClient;
...
import com.dogecoindark.dogecoindarkj.store.H2FullPrunedBlockStore;
import com.dogecoindark.dogecoindarkj.store.MemoryBlockStore;
import com.dogecoindark.dogecoindarkj.utils.BlockFileLoader;
...
/**
 * A tool for comparing the blocks which are accepted/rejected by bitcoind/dogecoindarkj
 * It is designed to run as a testnet-in-a-box network between a single bitcoind node and dogecoindarkj
